...
def dump_metadata_json(reader: GGUFReader, model) -> None:
    import json
    host_endian, file_endian = get_file_host_endian(reader)
...
def main() -> None:
    ...
    reader = GGUFReader("/workspace/foxran-chat/models/Qwen1.5-14B-GGUF/ggml-model-Q4_K.gguf", 'r')
    print(dump_metadata_json(reader, '/workspace/foxran-chat/models/Qwen1.5-14B-GGUF/ggml-model-Q4_K.gguf'))
